...
class Location(db.Model):
    ...
    #venues = db.relationship('Venues', backref='Cities', lazy=True)
...
def venues():
  ...
  # get all the cities and make a list of city dictionaries
  allcities = Location.query.all()
  numcities = len(allcities)
  datadict = []
  
  for city in allcities:
    citydict = {"city": city.city, "state": city.state, "venues": []}
    allvenuesforcity = Venue.query.filter_by(city=city.id)
    for venue in allvenuesforcity:
      venudict = {"id": venue.id, "name": venue.name}
      citydict["venues"].append(venudict)
    datadict.append(citydict)
  ...
  return render_template('pages/venues.html', areas=datadict);
